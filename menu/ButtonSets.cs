...
namespace ZenMenu.Menu
{
    internal class ButtonSets
    {
        ...
        },
        {
            ...
            new Dictionary<string, ButtonModule>()
            {
                { "PlaceHolder1", new ButtonModule("Place Holder","Place Holder",false,false,Catagory_:"Safety") },
                { "PlaceHolder2", new ButtonModule("Place Holder","Place Holder",false,false,Catagory_:"Safety") },
            }
        },
        {
            "Room",
